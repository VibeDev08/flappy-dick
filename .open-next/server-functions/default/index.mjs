...
var BuildId = "9VWgd_ihpmuGrkvxafeVN";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.svg/route": "/icon.svg", "/api/run-token/route": "/api/run-token", "/api/leaderboard/route": "/api/leaderboard", "/api/leaderboard/submit/route": "/api/leaderboard/submit", "/opengraph-image/route": "/opengraph-image", "/page": "/" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/opengraph-image": {}, "/api/run-token": {}, "/api/leaderboard": {}, "/api/leaderboard/submit": {} } };
